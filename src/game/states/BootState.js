...
import jsonMap from '../assets/isometric-grass-and-water.json'
...
export default {
  preload (){
    //this.load.json('map', require('@/game/assets/isometric-grass-and-water.json') );
    this.load.spritesheet('tiles',require('@/game/assets/isometric-grass-and-water.png'), { frameWidth: 64, frameHeight: 64 });
    this.load.spritesheet('skeleton',require('@/game/assets/skeleton8.png'), { frameWidth: 128, frameHeight: 128 });
    //this.load.image('house', '../assets/rem_0002.png');
    this.load.image('house',require('@/game/assets/rem_0002.png'));
  },
