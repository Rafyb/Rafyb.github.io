<template>
  <div class="home">
    ...
    <section id="home_autres">
      <h1 class='block'>Mes Compétences</h1>

      <h2 class='block'> > Langages utilisés</h2>
        <ul>
      ...
      <h2 class='block'> > Outils/Framework utilisés</h2>
        <ul>
        ...
        <h2 class='block'> > Langages déja manipulé</h2>
        <ul>
